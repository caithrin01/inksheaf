  ...
  try {
    for (const width of [1280, 390]) {
      ...
      const fits = await page.evaluate(() => {
        const mast=document.querySelector('#pv-mast').getBoundingClientRect(), dates=document.querySelector('#pv-dates').getBoundingClientRect(), foot=document.querySelector('.cv-footwrap').getBoundingClientRect(), front=document.querySelector('.cover-front').getBoundingClientRect();
