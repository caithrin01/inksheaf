// One layout evaluation supplies all nine page maps. Query and compile use the
...
export const METADATA_LABELS = ['artstart', 'artend', 'partstart', 'publisher-page', 'folio', 'fig', 'linkstart', 'parstart', 'parend'];
