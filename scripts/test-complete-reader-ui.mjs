...
for(const [engine,type] of [['chromium',chromium],['webkit',webkit]]){
 ...
 try{for(const width of [1280,390]){
  const page=await browser.newPage({viewport:{width,height:1000},reducedMotion:'reduce'}),errors=[],external=[];
