...
for(const file of ['fit.mjs','copy-fit.mjs','figure-details.mjs','prepare-figures.mjs','notes-detect.mjs','typst-emit.mjs','../build-book.mjs','../render-book.sh','../pdf-whitespace-audit.py','../blank-measure.py'])renderer.update(readFileSync(new URL(file,import.meta.url)));
