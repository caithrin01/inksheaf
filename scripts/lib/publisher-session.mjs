...
source_observations records completed source-image comparisons for this exact PDF page. They apply only to the specified glyph observation. If the printed screenshot faithfully preserves broken lettering from the source, do not call that same lettering a new typesetting failure. Still inspect the space around it and any separate loss, scale, crop or content defect; source fidelity never approves a page's composition.
