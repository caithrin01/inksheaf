...
const input={pdf_hash:'same-checked-pdf',pages:Array.from({length:14},(_,i)=>({page:i+1,findings:[],position:'complete short piece',printed_text:'A complete short poem.',unused_body_fraction_lower_bound:.5})),candidates:[]};
