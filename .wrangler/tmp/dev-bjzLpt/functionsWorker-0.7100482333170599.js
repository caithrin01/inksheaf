...
// .wrangler/tmp/pages-paNPkA/functionsWorker-0.7100482333170599.mjs
...
__name2(fetchArchive, "fetchArchive");
...
__name2(parseColor, "parseColor");
var lum = /* @__PURE__ */ __name2(([r, g, b]) => {
  const f = /* @__PURE__ */ __name2((v) => {
    v /= 255;
    return v <= 0.03928 ? v / 12.92 : ((v + 0.055) / 1.055) ** 2.4;
  }, "f");
  return 0.2126 * f(r) + 0.7152 * f(g) + 0.0722 * f(b);
}, "lum");
var contrast = /* @__PURE__ */ __name2((a, b) => {
  const [x, y] = [lum(a) + 0.05, lum(b) + 0.05];
  return x > y ? x / y : y / x;
}, "contrast");
var hex = /* @__PURE__ */ __name2((rgb) => "#" + rgb.map((v) => v.toString(16).padStart(2, "0")).join(""), "hex");
var json = /* @__PURE__ */ __name2((body, status = 200, extra = {}) => new Response(JSON.stringify(body), {
  status,
...
var ok = /* @__PURE__ */ __name2(() => new Response(
  JSON.stringify({ ok: true }),
  { headers: { "content-type": "application/json" } }
), "ok");
var bad = /* @__PURE__ */ __name2((m) => new Response(
...
// .wrangler/tmp/bundle-WJPVYk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WJPVYk/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7100482333170599.js.map
